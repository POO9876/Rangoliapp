...
public class FreeHandActivity extends AppCompatActivity {
    ...
    private int thumb[] = {R.drawable.freehand1, R.drawable.freehand2,R.drawable.freehand3,R.drawable.freehand4,R.drawable.freehand5,R.drawable.freehand6,R.drawable.freehand7,R.drawable.freehand8};
    ...
    class ImageAdapter extends BaseAdapter {
        ...
        public ImageAdapter(FreeHandActivity activity) {
