...
public class LordActivity extends AppCompatActivity {
    ...
    private int thumb[] = {R.drawable.lord1,R.drawable.lord2, R.drawable.lord3,R.drawable.lord4,R.drawable.lord5,R.drawable.lord6,R.drawable.lord7,R.drawable.lord8,R.drawable.lord9,R.drawable.lord10};
    ...
    class ImageAdapter extends BaseAdapter {
        ...
        public ImageAdapter(LordActivity activity) {
