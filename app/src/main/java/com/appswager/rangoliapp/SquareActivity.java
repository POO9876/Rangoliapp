...
public class SquareActivity extends AppCompatActivity {
    ...
    private int thumb[] = {R.drawable.square1, R.drawable.square2, R.drawable.square4, R.drawable.square5, R.drawable.square6, R.drawable.square8};
    ...
    class ImageAdapter extends BaseAdapter {
        ...
        public ImageAdapter(SquareActivity activity) {
