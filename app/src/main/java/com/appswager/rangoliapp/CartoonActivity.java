...
public class CartoonActivity extends AppCompatActivity {
    ...
    private int thumb[] = { R.drawable.cartoon1, R.drawable.cartoon2, R.drawable.cartoon3, R.drawable.cartoon4, R.drawable.cartoon5, R.drawable.cartoon6, R.drawable.cartoon7};
    ...
    class ImageAdapter extends BaseAdapter {
        ...
        public ImageAdapter(CartoonActivity activity) {
