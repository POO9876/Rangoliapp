...
public class PeocockActivity extends Activity {
    ...
    private int thumb[] = { R.drawable.peocock1, R.drawable.peocock2,
            R.drawable.peocock3, R.drawable.peocock4, R.drawable.peocock5,
            R.drawable.peocock6, R.drawable.peocock7,
            R.drawable.peocock8, R.drawable.peocock9, R.drawable.peocock10,
            R.drawable.peocock11 };
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_peocock);
    ...
    class ImageAdapter extends BaseAdapter {
        ...
        public ImageAdapter(PeocockActivity activity) {
